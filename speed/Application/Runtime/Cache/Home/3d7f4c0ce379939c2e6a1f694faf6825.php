...
<link rel="stylesheet" type="text/css" href="/speed/Public/css/jquery.Jcrop.min.css" media="all">
<link rel="stylesheet" type="text/css" href="/speed/Public/js/uploadify-v3.1/uploadify.css" media="all">
<script type="text/javascript" src="/speed/Public/js/jquery-1.7.2.min.js"></script>
<script type="text/javascript" src="/speed/Public/js/uploadify-v3.1/jquery.uploadify-3.1.min.js"></script>
<script type="text/javascript" src="/speed/Public/js/jquery.Jcrop.min.js"></script>
<script type="text/javascript" src="/speed/Public/js/ThinkBox/jquery.ThinkBox.js"></script>
<link rel="stylesheet" type="text/css" href="/speed/Public/js/ThinkBox/css/ThinkBox.css" media="all">
<title>头像上传示例</title>
<style type="text/css">
.main{
	margin: 0 auto;
...
.userup-icon {
    ...
    height: 16px;
    vertical-align: -2px;
	background: url("/speed/Public/public/img/userup_icon.png") no-repeat;
}
.uploadify-button {
...
.update-pic .crop {
    background: url("/speed/Public/public/img/mystery.png") no-repeat scroll center center #EEEEEE;
    float: left;
    margin-bottom: 20px;
    margin-top: 10px;
    overflow: hidden;
...
<div style="margin: 20px 0 10px;">
	...
	<div style="margin-bottom: 10px;">
		...
		<img style="max-width: 750px;" src="/speed/Public/avatar/temp.jpg" title="临时图片"/>
	</div>
	<div>
		<span style="vertical-align: top">裁切图片：</span>
		<img src="/speed/Public/avatar/avatar_100.jpg" title="100*100"/>
		<img src="/speed/Public/avatar/avatar_60.jpg" title="60*60"/>
		<img src="/speed/Public/avatar/avatar_30.jpg" title="30*30"/>
	</div>
</div>
<!-- /展示头像 -->
</div>
...
<script type="text/javascript">
	$(function(){
		...
		$("#user-pic").uploadify({
			...
			'preventCaching' : true,
			'multi'    : false,
			'swf' 			: '/speed/Public/js/uploadify-v3.1/uploadify.swf',
