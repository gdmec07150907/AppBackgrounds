...
$(function(){
  ...
  $('.input-group a').click(function(){
    className = $(this).attr('class');
    $('#addBg').fadeIn(300);
    $('#add').removeAttr('class').addClass('animated '+className+'').fadeIn();
  });
  //关闭弹窗
  $('.claseDialogBtn').click(function(){
    $('#addBg').fadeOut(300,function(){
      $('#add').addClass('bounceOutUp').fadeOut();
    });
  });
});
</script>
...
$(function(){
  $(".admin").each(function(){
    ...
    btn.bind("click",function(){
      ...
      $("#name").val(name);
      var password = btn.parent().parent().children("td").get(2).innerHTML;
      $("#password").val(password);
      var phone = btn.parent().parent().children("td").get(3).innerHTML;
      $("#phone").val(phone);
      var idcard = btn.parent().parent().children("td").get(4).innerHTML;
      $("#idcard").val(idcard);
      var sex = btn.parent().parent().children("td").get(5).innerHTML;
      $("#sex").val(sex);
      var power = btn.parent().parent().children("td").get(6).innerHTML;
      $("#power").val(power);
      var state = btn.parent().parent().children("td").get(8).innerHTML;
      $("#state").val(state);
    })
  })
})
...
<div class="top_nav">
      ...
      <div class="right_col" role="main">
          <div class="">
            <div class="page-title">
              ...
              <form action="/speed/index.php/Home/Admin/../admin" method="get" name="search">
                    ...
                    <table id="datatable" class="table table-striped jambo_table bulk_action">
                      <thead>
                          <tr>
                            ...
                            <th class="column-title" colspan="2">操作</th>
                          </tr>
                      </thead>
                      <tbody>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class = "admin">
                              <td><?php echo ($vo["administrators_id"]); ?></td>
                              <td><?php echo ($vo["administrators_name"]); ?></td>
                              <td><?php echo ($vo["administrators_phone"]); ?></td>
                              <td><?php echo ($vo["administrators_idnumber"]); ?></td>
                              <td><?php echo ($vo["administrators_email"]); ?></td>
                              <td><?php echo ($vo["administrators_sex"]); ?></td>
                              <td><?php echo ($vo["administrators_jurisdiction"]); ?></td>
                              <td><?php echo ($vo["administrators_date"]); ?></td>
                              <td><?php echo ($vo["administrators_state"]); ?></td>
                              <td><button><a href="javascript:;" id="update">修改</a></button></td>
                              <td><a href="/speed/index.php/Home/Admin/delete/administrators_id/<?php echo ($vo["administrators_id"]); ?>" onclick='return del();'><button>删除</button></a></td>
    ...
    <div id="dialog" class="animated">
      ...
      <form action="/speed/index.php/Home/Admin/Updatado" method="post" id="editForm">
        <ul class="editInfos">
          ...
          <li><label>手机&nbsp;&nbsp;&nbsp;号码：<input type="text" name="phone" required value="" class="ipt" id="password"/></label></li>
          <li><label>身份证号码：<input type="text" name="idnumber" required value="" class="ipt" id="phone" /></label></li>
          <li><label>邮箱&nbsp;&nbsp;&nbsp;地址：<input type="text" name="email" required value="" class="ipt" id="idcard" /></label></li>
          <li><label>性&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;别：
          ...
          <li><label>权&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;限：
          <select class="ipt" id="power" name="power">
    ...
    <div id="addBg"></div>
    <div id="add" class="animated">
      <img class="dialogIco" width="50" height="50" src="../Public/images/ico.png" alt="" />
      <div class="dialogTop">
        <a href="javascript:;" class="claseDialogBtn">关闭</a>
      </div>
      <form action="/speed/index.php/Home/Admin/Adddo" method="post" id="editForm">
        <ul class="editInfos">
          <li><label>昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：<input type="text" name="name1" required value="" class="ipt" id="name1"/></label></li>
