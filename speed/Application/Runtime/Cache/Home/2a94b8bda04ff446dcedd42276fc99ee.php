...
$(function(){
  ...
  $('.fuck #update').click(function(){
    ...
    $('#userdialogBg').fadeIn(300);
    $('#userdialog').removeAttr('class').addClass('animated '+className+'').fadeIn();
  });
  
  //关闭弹窗
  $('.claseDialogBtn').click(function(){
    $('#userdialogBg').fadeOut(300,function(){
      $('#userdialog').addClass('bounceOutUp').fadeOut();
    });
  });
});
...
$(function(){
  ...
  $('.input-group a').click(function(){
    className = $(this).attr('class');
    $('#useraddBg').fadeIn(300);
    $('#useradd').removeAttr('class').addClass('animated '+className+'').fadeIn();
  });
  //关闭弹窗
  $('.claseDialogBtn').click(function(){
    $('#useraddBg').fadeOut(300,function(){
      $('#useradd').addClass('bounceOutUp').fadeOut();
    });
  });
});
</script>
...
<div class="top_nav">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <form action="/speed/index.php/Home/Index/../index" method="get" name="search">
                ...
                <div class="x_panel">
                  ...
                  <div class="fuck"> 
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
                      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr class="user">
                          ...
                          <td><?php echo ($user["user_idnumber"]); ?></td>
                          <td><?php echo ($user["user_date"]); ?></td>
                          <td><?php echo ($user["user_credit"]); ?></td>
                          <td><?php echo ($user["user_state"]); ?></td>
                          <td><button><a href="javascript:;" id="update">修改</a></button>
                             <button><a href="/speed/index.php/Home/Index/delete/user_id/<?php echo ($user["user_id"]); ?>" onclick='return del();'>删除</a></button></td>
        ...
        <div id="userdialogBg"></div>
    <div id="userdialog" class="animated">
      <img class="dialogIco" width="50" height="50" src="/speed/Public/images/ico.png" alt="" />
      <div class="dialogTop">
        <a href="javascript:;" class="claseDialogBtn">关闭</a>
      </div>
      <form action="/speed/index.php/Home/Index/userUpdatado" method="post" id="editForm">
        <ul class="editInfos">
    ...
    <div id="useraddBg"></div>
    <div id="useradd" class="animated">
      <img class="dialogIco" width="50" height="50" src="/speed/Public/images/ico.png" alt="" />
      <div class="dialogTop">
        <a href="javascript:;" class="claseDialogBtn">关闭</a>
      </div>
      <form action="/speed/index.php/Home/Index/userAdddo" method="post" id="editForm">
        <ul class="editInfos">
